    ...
    <>
      <div className=" max-w-full md:block flex justify-center items-center grid grid-cols-1 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <form className="bg-white p-4 md:mx-16 lg:w-max-w-md lg:justify-center lg:items-center lg:mx-48 xl:mx-48">
            ...
            <h1 className="my-4 block mb-2 font-medium text-gray-900 dark:text-white">Skills</h1>
            ...
            <h2 className="my-4 block mb-2 font-medium text-gray-900 dark:text-white">Add Social Profile</h2>
            ...
            <h2 className="my-4 mb-2 font-medium text-gray-900 dark:text-white">Add Experience</h2>
            <div className="md:block flex flex-col justify-center items-center">
              {experiences.map((experience, index) => (
                <div key={index} className="gap-4 grid grid-cols-2 flex flex-row items-center mb-4">
                  <input
