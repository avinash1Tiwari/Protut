...
import LoginImage from '../../Assets/CardThree.png';
  ...
  return (
    ...
    <form className="flex flex-col justify-center items-center bg-white h-screen">
      ...
      <img src={BannerImage} alt="" className=" w-44 h-12 mx-auto mb-6" />
         <h1 className='text-center text-2xl font-bold mb-6'>Login as candidate</h1>
        <input
          type="email"
          placeholder="Email"
        ...
        <button className="text-blue-500 w-full mb-4">Forgot Password?</button>
        ...
        <p className="text-blue-500 mt-3 text-center cursor-pointer">Signup here</p>
      </div>
    </form>
